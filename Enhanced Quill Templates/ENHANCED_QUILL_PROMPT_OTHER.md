# Enhanced Other Meeting Prompt

This prompt formats a meeting that doesn't fit into a predefined category. It gathers information related to a recorded meeting in the Quill macOS app and outputs markdown structured for use in Obsidian.
...
{
  "summary_markdown": "---\ndate: {{YYYY-MM-DD}}\nmeeting_title: \"Meeting – {{Topic}}\"\nproject: \"miscellaneous\"\nsession_type: \"other\"\nparticipants: [\"{{Your Name}}\", \"{{Name}}\", \"{{Name}}\"]\nsummary: \"{{Purpose/outcome}}\"\nnext_meeting_focus: \"{{optional}}\"\ntags:\n  - \"#meeting\"\n  - \"#quill\"\n  - \"#other\"\n  - \"#{{optional tag 1}}\"\n  - \"#{{optional tag 2}}\"\nsource: \"quill\"\n---\n# Meeting – {{Topic}}\n\n## Summary\n{{Brief, natural-language overview of the meeting's purpose, themes, and key takeaways.}}\n\n## Key Topics Discussed\n- **{{Topic Name}}**: {{Summary of discussion or updates for this area}}\n- **{{Topic Name}}**: {{Another focus of discussion}}\n\n## Followup Tasks\n- [ ] {{Task description}}\n- [ ] {{Another task description}}\n\n## Open Questions or Follow-ups\n- {{List any unresolved issues, blockers, or things to revisit}}\n\n## Detailed Notes\n{{Narrative-style notes grouped by topic. Use multiple paragraphs to improve readability.}}\n",
  "meeting_title": "Meeting – {{Topic}}",
  "meeting_date": "{{YYYY-MM-DD}}",
