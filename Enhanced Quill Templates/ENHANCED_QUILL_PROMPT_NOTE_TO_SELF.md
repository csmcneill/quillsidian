# Enhanced Note to Self Meeting Prompt

This prompt formats a personal reflection or solo work session. It gathers information related to a recorded meeting in the Quill macOS app and outputs markdown structured for use in Obsidian.
...
{
  "summary_markdown": "---\ndate: {{YYYY-MM-DD}}\nmeeting_title: \"Note to Self – {{Theme}}\"\nproject: \"miscellaneous\"\nsession_type: \"note-to-self\"\nparticipants: [\"{{Your Name}}\"]\nsummary: \"{{One-sentence summary}}\"\ntags:\n  - \"#meeting\"\n  - \"#quill\"\n  - \"#note-to-self\"\n  - \"#{{optional tag}}\"\nsource: \"quill\"\n---\n# Note to Self – {{Theme}}\n\n## Reflections\n{{Narrative reflections across 1–3 short paragraphs.}}\n\n## Followup Tasks\n- [ ] {{Task description}}\n- [ ] {{Another task}}\n\n## Open Questions or Things to Revisit\n- {{Unresolved idea or thread}}\n",
  "meeting_title": "Note to Self – {{Theme}}",
  "meeting_date": "{{YYYY-MM-DD}}",
